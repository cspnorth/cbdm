...
class Builder_Maps_Pro {
	...
	public function admin_enqueue() {
		...
		wp_enqueue_script( 'builder-maps-pro-admin', themify_enque($this->url . 'assets/admin.js'), array( 'jquery', 'jquery-ui-draggable' ), $this->version, false );
		wp_enqueue_style( 'builder-maps-pro-admin', themify_enque($this->url . 'assets/admin.css' ));
